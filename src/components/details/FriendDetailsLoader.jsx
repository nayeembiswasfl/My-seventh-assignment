  ...
  return (
    <section className="content-shell py-16 sm:py-24">
      <div className="rounded-[32px] border border-slate-200 bg-white/70 px-6 py-20 text-center shadow-sm">
        ...
        <h2 className="mt-8 text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl">Loading friend details</h2>
        <p className="mx-auto mt-3 max-w-xl text-base text-[#6c7a93] sm:text-lg">
          Pulling the profile, goal, and reminder stats from your friend data.
        </p>
      </div>
    </section>
  );
...
export default FriendDetailsLoader;
